...
| Tool | Description |
|------|-------------|
| [Claude Code](https://github.com/anthropics/claude-code) | Anthropic's official CLI-based AI coding assistant |
| [Codex](https://github.com/openai/codex) | OpenAI's terminal-based AI coding agent |
| [Gemini CLI](https://github.com/google-gemini/gemini-cli) | Google's open-source CLI powered by Gemini |
| [OpenCode](https://github.com/opencode-ai/opencode) | Open-source AI coding assistant for terminal |
| [Amp](https://sourcegraph.com/amp) | Sourcegraph's agentic AI coding assistant |

## AI-Powered IDEs

| Tool | Description |
|------|-------------|
| [VS Code](https://code.visualstudio.com/) | Microsoft's code editor with AI (Copilot) integration |
| [Cursor](https://cursor.com/) | AI-first code editor built for productivity |
...
| Tool | Description |
|------|-------------|
| [HeyGen](https://heygen.com/) | AI avatar-based video generation platform |
